...
def release_connection_cabina(persona_id):
    """ Libera una cabina. Lanza ValueError si se libera de más. """
...
def use_resource_cabina(persona_id):
    ...
    try:
        ...
        cabina_ocupada = True
        tiempo_llamada = random.uniform(1, 2)
        print(f"Persona {persona_id} (Cabina): Hablando por {tiempo_llamada:.2f} segundos.")
