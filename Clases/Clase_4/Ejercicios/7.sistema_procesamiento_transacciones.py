...
#Implementa un sistema donde múltiples procesos "generadores" crean transacciones (operaciones con un ID, tipo y monto), las envían a un 
# proceso "validador" que verifica su integridad, y finalmente a un proceso "registrador" que acumula las estadísticas. Usa múltiples pipes 
# para manejar este flujo complejo y asegúrate de manejar correctamente la sincronización y el cierre de la comunicación.

# python3 7.sistema_procesamiento_transacciones.py
import os
import sys
import time
import random
